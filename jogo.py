...
dataset = pd.read_excel('RealMadrid_1tempo.xlsx')
...
grafico = sns.jointplot(X, y, stat_func=None, kind='kde', space=0, color=cmap(0.1), cmap=cmap, n_levels=50)
...
ax.set_title('Ações do Real Madrid no 1 tempo - Real Madrid 0 x 3 Barcelona', y=1.2, fontsize=12)

#Salvar no computador
plt.savefig('RealMadrid_1Tempo.png', bbox_inches='tight', format='png', dpi=300)
